...
@section('content')
    ...
    <!-- Hero Section Starts -->
    <div class="container pt-4 col-xxl-8">
    ...
    <!-- Hero Section Ends -->
    <!-- Icon Grid Starts -->
    <div class="container pt-4" id="icon-grid">
        ...
        <div class="row row-cols-1 row-cols-lg-3 align-items-stretch g-4 py-5">
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg"
                    style="background-image: url('{{ asset('images/unsplash-photo-1.jpg') }}');">
            ...
            <div class="col">
                <div class="card card-cover h-100 overflow-hidden text-bg-dark rounded-4 shadow-lg"
                    style="background-image: url('{{ asset('images/unsplash-photo-3.jpg') }}');">
